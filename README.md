...
The purpose of this macro is to ascertain if a GNU Bison Skeleton file should be used for the configuration and building of a package, and if so, then which Skeleton should be used.
